  ...
  return (
    <div className="flex flex-col h-screen text-gray-200 overflow-hidden">
      <main className="flex-grow flex items-center justify-center p-4 sm:p-8">
        <div key={currentSlide} className="w-full max-w-6xl aspect-[16/9] bg-[#161b22] rounded-2xl border border-[#F3CB13]/40 flex flex-col justify-center animate-fadeIn p-6 md:p-12">
